...
/**
 * Perform a matrix-matrix multiplication C = A*B using an improved implementation (linear access)
 ...
 */
void matmatLinear(double *C, const double *A, const double *B,
                  int m, int n, int p)
{
        // Implement a linear memory access matmat (about 5 lines of code)
...
int main(int argc, char* argv[])
{
        ...
        cout << "Time for a linear access matrix-matrix multiplication: "
