...
void startChrono() { startTime = system_clock::now(); }
...
void threadsum(int threadID, int numThreads, const vector<double> &v,
               vector<double> &globalSum) {
...
int main(int argc, char *argv[]) {
  ...
  cout << "Summing " << N << " values using " << numThreads << " thread(s)."
       << endl;
